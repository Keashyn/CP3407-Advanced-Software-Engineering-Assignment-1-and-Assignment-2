...
def generateMonthlyReport(userID, year=None):
    ...
    spending_month_chart = spendee_dashboard.getMonthlySpending(userID, year)
...
def generateSpendingTrendsReport(userID, year=None):
    ...
    spending_trends_chart = spendee_dashboard.getSpendingTrends(userID, year)
    ...
    categories_active = spendee_categories.getSpendCategories(userID)
    ...
    categories_inactive = spendee_categories.getSpendCategories_Inactive(userID)
